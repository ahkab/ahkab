...
project = u'ahkab'
copyright = u'2006-2015, Giuseppe Venturini'
...
with open(os.path.join(os.path.dirname(__file__), "..", "ahkab", "__version__.py")) as fp:
# You can't use import here.
	version = release = fp.read().strip().split("=")[1].strip()[1:-1]
